...
import 'package:screen_main/courses_detail_screen.dart';
          ...
          child: Row(
            children: const [
              ...
              Icon(Icons.arrow_forward_ios_rounded,
                  size: 14, color: Color(0xff2DBA63)),
            ],
          ),
        )
      ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text('Hilltop Valley Golf Club ',
                          style: TextStyle(
                              fontSize: 15,
                              fontFamily: 'SVN-Gilroy',
                              fontWeight: FontWeight.w700)),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset(
                            'assets/images/ic_golf_course.png',
                            width: 14,
                            height: 14,
                          ),
